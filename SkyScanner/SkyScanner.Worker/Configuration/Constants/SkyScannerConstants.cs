...
namespace Arkive.SkyScanner.Constants
{
    ...
    {
        public const string PostUrl = "/g/conductor/v1/fps3/search/?geo_schema=skyscanner&carrier_schema=skyscanner&response_include=query%3Bdeeplink%3Bsegment%3Bstats%3Bfqs%3Bpqs";
        public const string BaseLink = @"https://www.skyscanner.ie";
        public const string Referer = "https://www.skyscanner.ie/transport/flights/dub/bom/{0}/{1}/?adults=1&children=0&adultsv2=1&childrenv2=&infants=0&cabinclass=economy&rtn=1&preferdirects=false&outboundaltsenabled=false&inboundaltsenabled=false&ref=home";
